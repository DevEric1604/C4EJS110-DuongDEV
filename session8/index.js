...
// function caculator() {
//     let caculator = 0;
//     document.getElementById("view").textContent = caculator;
...
//     text.innerText = quesdata[0]["quoteText"];
//     author.innerText = quesdata[0]["quoteAuthor"];
//     reload.addEventListener("click", () => {
//         let randomQ = Math.floor(Math.random() * quesdata.length);
//         let randomQuote = quesdata[randomQ];
